...
v4l2-ctl -d /dev/video0 -c brightness=16
v4l2-ctl -d /dev/video0 -c contrast=36
v4l2-ctl -d /dev/video0 -c saturation=78
v4l2-ctl -d /dev/video0 -c hue=6
v4l2-ctl -d /dev/video0 -c white_balance_automatic=0
v4l2-ctl -d /dev/video0 -c exposure=255
v4l2-ctl -d /dev/video0 -c gain_automatic=0
v4l2-ctl -d /dev/video0 -c gain=3
