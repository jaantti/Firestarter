...
char comports[30][16]={"/dev/ttyS0","/dev/ttyS1","/dev/ttyS2","/dev/ttyS3","/dev/ttyS4","/dev/ttyACM0",
                       "/dev/ttyACM1","/dev/ttyACM2","/dev/ttyACM3","/dev/ttyACM4","/dev/ttyACM5","/dev/ttyACM6",
